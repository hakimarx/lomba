...
// Check system config for mushaf source
include_once __DIR__ . "/../global/class/fungsi_config.php";
$mushafSource = getConfig('mushaf_source', 'offline');

if ($mushafSource === 'online') {
    // Use online API (everyayah.com)
    $link = "https://everyayah.com/data/images_png/" . $halaman . ".png";
} else {
...
<div class="mushaf">
    ...
    <div class="tengah">
        <div class="tombol">
            ...
            <span class="bulat circle" onclick=zoom(-5)>-</span>
            <a class="bulat circle" href="?page=mushaf&jenis=<?php echo $jenis; ?>&halaman=<?php echo $sebelum; ?>">
                << /a>
