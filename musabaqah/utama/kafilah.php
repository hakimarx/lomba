<?php
    ...
    function hapus($id){
        $query="delete from kafilah where id=$id";
        ekse($query);
    }
    ...
    function update($id=""){
    	$nama=$_POST['nama'];
        if($id==""){    //tambah
            $query="insert into kafilah(nama) values('$nama')";
        }else{          //edit
            $query="update kafilah set nama='$nama' where id=$id";
        }
        ekse($query);
    }
    ...
    function tampil(){
        ...
        while($row=mysqli_fetch_array($mquery)){
            ...
            print("<tr>
                ...
                <td><input class='panel button padding' type=button onclick='edit($id)' value=edit></td>
                <td><input class='panel button padding' type=button value=hapus onclick='hapus($id);'></td>
            </tr>\n");
        }
    }
